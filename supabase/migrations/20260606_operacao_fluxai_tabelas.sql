...
-- 4. GRANTS EXPLÍCITOS PARA SERVICE_ROLE (GATE 4E)
GRANT SELECT, INSERT, UPDATE, DELETE ON public."CONTRATOS_CLIENTES" TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public."DNA_CLIENTE_GPT" TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public."IA_CREDITOS_CLIENTE" TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public."CLIENTES_ESTRATEGIA" TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public."SERVICOS_EXTRAS_CLIENTES" TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public."FINANCEIRO_CLIENTES" TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public."DEMANDAS_CLIENTES" TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public."COMUNICACOES_CLIENTE" TO service_role;
