...
export const STATUS_SYSTEM = {
    ...
    conteudos: {
        draft_planning: { value: 'draft_planning', label: 'Rascunho / Pauta', badge: 'neutral', color: '#6b7280', description: 'Pauta inicial ou rascunho.', allowedTransitions: ['internal_review'], authorizedRoles: ['ADMIN', 'OPERATOR'] },
        ...
        client_revision_planning: { value: 'client_revision_planning', label: 'Ajuste Solicitado', badge: 'danger', color: '#ef4444', description: 'Cliente pediu ajustes na pauta.', allowedTransitions: ['internal_review'], authorizedRoles: ['ADMIN', 'OPERATOR', 'CLIENT'] },
        ...
        in_production: { value: 'in_production', label: 'Em Produção', badge: 'warning', color: '#f59e0b', description: 'Artes e vídeos sendo gerados.', allowedTransitions: ['internal_qa'], authorizedRoles: ['ADMIN', 'OPERATOR'] },
        internal_qa: { value: 'internal_qa', label: 'QA Interno', badge: 'info', color: '#8b5cf6', description: 'Controle de qualidade interno da FluxAI.', allowedTransitions: ['client_review_content'], authorizedRoles: ['ADMIN', 'OPERATOR'] },
        ...
        client_revision_content: { value: 'client_revision_content', label: 'Ajuste de Arte', badge: 'danger', color: '#ef4444', description: 'Cliente pediu ajustes na arte.', allowedTransitions: ['in_production'], authorizedRoles: ['ADMIN', 'OPERATOR', 'CLIENT'] },
