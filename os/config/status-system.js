...
export const STATUS_SYSTEM = {
    ...
    conteudos: {
        draft_planning: { value: 'draft_planning', label: 'Rascunho / Pauta', badge: 'neutral', color: '#6b7280', description: 'Pauta inicial ou rascunho.', allowedTransitions: ['internal_review', 'client_review_planning', 'client_revision_planning', 'planning_approved', 'client_revision_content'], authorizedRoles: ['ADMIN', 'OPERATOR', 'CLIENT'] },
        ...
        client_review_planning: { value: 'client_review_planning', label: 'Aprovação do Cliente', badge: 'info', color: '#3b82f6', description: 'Aguardando cliente aprovar a pauta.', allowedTransitions: ['client_revision_planning', 'planning_approved', 'client_revision_content'], authorizedRoles: ['ADMIN', 'OPERATOR'] },
