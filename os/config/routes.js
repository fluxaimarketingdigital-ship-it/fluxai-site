...
export const ROUTES = [
    { id: 'command-center', label: 'Centro de Comando', icon: 'fa-terminal', group: 'Núcleo Estratégico', path: '../../modules/command-center/command-center.html', roles: ['ADMIN', 'OPERATOR'] },
