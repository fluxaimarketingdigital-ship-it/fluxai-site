...
const SCENARIOS = [
...

    {
        ...
        steps: [
            ...
            { page: '/os/clientes.html',    caption: '📍 Módulo Clientes', speech: 'Depois de convertido, o cliente é cadastrado no módulo Clientes com dados de contato e o link do Drive.', duration: 10, highlight: 'button.btn-primary' },
...

    {
        ...
        steps: [
            ...
            { page: '/os/client-portal.html', caption: '✅ Visão Geral', speech: 'Aqui você acompanha tudo que estamos produzindo. A seção Aguardando Sua Aprovação é a mais importante.', duration: 10, highlight: '.approval-section' },
            ...
            { page: '/os/client-portal.html', caption: '➕ Nova Solicitação', speech: 'Para pedir uma nova pauta, clique em Nova Solicitação e preencha os detalhes da sua necessidade.', duration: 9, highlight: 'button.btn-new' },
